...
{
    internal class Reptiles : Animal, IAnimalMethods
    {
        ...
        public double calcDosage(Medication med)
        {
            ...
            Console.WriteLine($"Dosage for {AnimalName} (Reptile) with weight {AnimalWeight}kg: {dosage} mg of {med.MedName}");
            return dosage;
        }

    }//End of reptiles class
}//End of namespace
